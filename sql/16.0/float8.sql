...
--Testcase 252:
INSERT INTO NON_ERROR_THROWING_API VALUES ('34.5', 1), ('xyz', 2), ('1e4000', 3);
SELECT pg_input_is_valid(f1, 'float8') FROM NON_ERROR_THROWING_API WHERE id = 1;
--Testcase 253:
SELECT pg_input_is_valid(f1, 'float8') FROM NON_ERROR_THROWING_API WHERE id = 2;
--Testcase 254:
SELECT pg_input_is_valid(f1, 'float8') FROM NON_ERROR_THROWING_API WHERE id = 3;
--Testcase 255:
SELECT * FROM pg_input_error_info((SELECT f1 FROM NON_ERROR_THROWING_API WHERE id = 3), 'float8');
--Testcase 256:
